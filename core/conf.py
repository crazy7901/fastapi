...
class Settings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_file=f'{BasePath}/env.conf', env_file_encoding='utf-8', extra='ignore')
    ...
    # Env Opera Log
    OPERA_LOG_ENCRYPT_SECRET_KEY: str = 'd77b25790a804c2b4a339dd0207941e4cefa5751935a33735bc73bb7071a005b'  # 密钥 os.urandom(32), 需使用 bytes.hex() 方法转换为 str

    # FastAPI
    API_V1_STR: str = '/api/v1'
    TITLE: str = 'VHawk-CDC 后端接口文档'
    VERSION: str = '0.0.1'
    DESCRIPTION: str = 'FastAPI-VHawk-CDC'
